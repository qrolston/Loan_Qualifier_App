...
def load_csv(csvpath):
    ...
    """
    return new_func(csvpath)

def new_func(csvpath):
...
def save_csv(csv_loc, qualifying_loans, header):
    """Saves the CSV file from path provided.

    Args:
        csv_loc (Path): The CSV file path/location
    ...
    with open(csv_loc, "w", newline="") as csvfile:
        ...
        csvwriter.writerow(header)
         ...
         # Write the values of each dictionary 
